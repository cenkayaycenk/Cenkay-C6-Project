...
public class c2_CollectionsMethods {
    public static void main(String[] args) {
        // We said ArrayList is a collection.
        // sort() this will sort the ArrayList in increasing order// We us it like Collections.sort(list)
